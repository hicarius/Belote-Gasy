    ...
    public function createTable()
    {
        ...
        switch ($this->driver) {
            case 'mysql':
                ...
                $sql = "CREATE TABLE IF NOT EXISTS $this->table ($this->idCol VARBINARY(128) NOT NULL PRIMARY KEY, $this->dataCol BLOB NOT NULL, $this->lifetimeCol MEDIUMINT NOT NULL, $this->timeCol INTEGER UNSIGNED NOT NULL) COLLATE utf8_bin, ENGINE = InnoDB";
                break;
            case 'sqlite':
